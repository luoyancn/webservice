...
daemon_server_port = _config.get('security', 'daemon_server_port')
wafs_image_id = _config.get('security', 'wafs_image_id')
ips_image_id = _config.get('security', 'ips_image_id')
vpn_image_id = _config.get('security', 'vpn_image_id')
virus_image_id = _config.get('security', 'virus_image_id')
